...
def taskfilter():
    ...
    df_north = df_hour[(df_hour['Direction Name'] == 'North')]
...
filter_north = taskfilter()

#group according to individual north lanes
group_north_lanes = filter_north.groupby('Lane Name')

df_stats = pd.DataFrame(calculate_measure(group_north_lanes))
print(df_stats)
